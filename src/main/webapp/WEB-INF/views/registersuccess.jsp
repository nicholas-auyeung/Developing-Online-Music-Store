...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-login">
      ...
      <div class = "container registration-success-outer-container">
        <div class = "container registration-success-container">
            <h1>Customer registered successfully!</h1>
        </div>
      </div><br/>
      <a class="btn btn-outline-primary registration-success-button" href="/products" role="button"><i class="fa fa-hand-o-left"></i> products</a>
